...
export default function TrainerChat() {
  ...
  const { connected, joinChat, leaveChat, sendMessage, markAsRead, startTyping, stopTyping } = useChatSocket({
    onMessage: (msg) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['trainer-chats'] });
    },
      ...
      {selectedChat ? (
          ...
          <div className="flex items-center gap-3 p-4 border-b border-border/50">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs">
                {isOtherOnline ? <span className="text-emerald-400">Online</span> : <span className="text-muted-foreground">Aluno</span>}
              </div>
            </div>
        ...
        <div className="hidden lg:flex flex-1 glass rounded-2xl items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Escolha um aluno à esquerda para começar</p>
          </div>
        </div>
      )}
    </div>
