        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide">
          {filteredChats.length > 0 ? (
            filteredChats.map((chat: any) => {
              ...
              const colors = ['from-emerald-600 to-teal-600', 'from-cyan-600 to-blue-600', 'from-purple-600 to-indigo-600'];
      ...
      {selectedChat ? (
        ...
        <div className="hidden lg:flex flex-1 glass rounded-2xl items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Escolha um paciente à esquerda para começar</p>
          </div>
        </div>
      )}
    </div>
