  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#6f5cf020', '#06b6d420']} style={styles.header}>
        <Text style={styles.title}>Painel do Trainer</Text>
        <Text style={styles.subtitle}>Gerencie seus alunos e treinos</Text>
      </LinearGradient>
      <View style={styles.empty}>
        <Text style={styles.emptyIcon}>🏋️</Text>
        <Text style={styles.emptyText}>Painel do Trainer</Text>
        <Text style={styles.emptySubtext}>Em breve você poderá gerenciar seus alunos aqui</Text>
      </View>
    </View>
  );
}
