...
export default function NutritionistChatScreen() {
  ...
  if (selectedRoom) {
    ...
    const otherName = `${otherUser?.profile?.firstName || ''} ${otherUser?.profile?.lastName || ''}`.trim() || 'Usuário';
    const otherInitials = getInitials(otherUser?.profile?.firstName, otherUser?.profile?.lastName);
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient colors={['#6f5cf020', '#06b6d420']} style={styles.header}>
        ...
        <Text style={styles.subtitle}>Converse com seus pacientes</Text>
      </LinearGradient>
      ...
      {loadingRooms ? (
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.emptySubtext}>Seus pacientes poderão entrar em contato com você aqui</Text>
        </View>
      ) : (
              ...
              >
                ...
                <View style={styles.roomInfo}>
                  <View style={styles.roomTopRow}>
                    ...
                    {lastMsg && (
                      <Text style={styles.roomTime}>{timeAgo(lastMsg.createdAt)}</Text>
                    )}
                  </View>
